...
class ShoppingListMock {
  static Future<void> insertMocks() async {
    ...
    final shoppingList1 =
        ShoppingList(id: 0, name: "mijne lijst", ingredients: [ingrAmount1, ingrAmount2]);
    final shoppingList2 =
        ShoppingList(id: 0, name: "mijne lijst part 2", ingredients: [ingrAmount2, ingrAmount1]);
  ...
  static Future<void> logMocks() async {
    ...
    for (final l in shoppingLists) {
      ...
      for (final i in l.ingredients) {
        print("- ${i.ingredient.name}: ${i.amount}${i.ingredient.unit.toShortString()}");
      }
    }
  }
}
